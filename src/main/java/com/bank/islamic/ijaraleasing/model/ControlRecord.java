package com.bank.islamic.ijaraleasing.model;
...
/**
 * The BIAN control record for this service domain: "Ijara Lease Fulfillment Arrangement".
 *
 ...
 * to its asset type (Ijara Lease). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Ijara Lease Fulfillment Arrangement";
